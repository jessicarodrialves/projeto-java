...
public class Menu {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				System.out.println("========================================================");
				System.out.println( Cores.TEXT_YELLOW_BOLD + "               Digite uma opção:                        " + Cores.TEXT_RESET);
				System.out.println("========================================================");
				...
				switch (opcao) {
					case 1:	
						...
						if(!nome.matches("^[A-Za-z]*$")) {
							System.out.println("Tipo de entrada inválida!, favor informar letras");
							break;
						}
						...
						if(categoria == 1) {
							...
							if(!tipoColar.matches("^(Longo|Curto)$")) {
								System.out.println("Tipo de entrada inválida!, favor informar (Longo ou Curto)");
								break;
							}
							...
							if(!tipoMaquiagem.matches("^[A-Za-z]*$")) {
								System.out.println("Tipo de entrada inválida!, favor informar letras");
								break;
							}
